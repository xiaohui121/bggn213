Class 17: Metagenomics co-occurence networks
================
...
```
    ...
    ##  [1] "Nested Network Style" "Directed"             "Minimal"             
    ##  [4] "Solid"                "BioPAX_SIF"           "Curved"              
    ##  [7] "Big Labels"           "default"              "Sample1"             
    ## [10] "Universe"             "Sample2"              "Sample3"             
    ## [13] "Gradient1"            "default black"        "BioPAX"              
    ## [16] "size_rank"            "Marquee"              "Ripple"
...
we can query (and set) vertex and edge attributes with the `V()` and
...
```
    ...
    ## + 845/845 vertices, named, from 4183694:
...
```
    ...
    ## + 1544/1544 edges from 4183694 (vertex names):
...
Community detection with the Girvin
    Newmen:
...
We can extract a cluster/community membership vector for further
...
Let’s plot our network with nodes size scaled via this page rank
centrality scores.
...
calculated previously and stored as the object `d`.
